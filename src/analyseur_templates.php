...
class TemplateAnalyzer
{
    ...
    public static function getExpectedContextKeys(): array
    {
        return [
            // Societe
            'SOCIETE_RAISON_SOCIALE', 'SOCIETE_SIGLE', 'SOCIETE_FORME_JURIDIQUE', 'SOCIETE_ICE',
            'SOCIETE_RC', 'SOCIETE_IF', 'SOCIETE_CAPITAL', 'SOCIETE_PART_SOCIAL',
            'SOCIETE_VALEUR_NOMINALE', 'SOCIETE_VILLE', 'SOCIETE_TRIBUNAL', 'SOCIETE_TRIBUNAL_TYPE',
            'SOCIETE_ADRESSE_SIEGE', 'SOCIETE_EMAIL', 'SOCIETE_TELEPHONE',
            'SOCIETE_DOSSIER', 'SOCIETE_DOSSIER_CREATION', 'SOCIETE_TYPE_GENERATION', 'SOCIETE_PROCEDURE_CREATION',
            'SOCIETE_MODE_DEPOT', 'SOCIETE_DATE_ICE', 'SOCIETE_DATE_EXP_CERT_NEG',
            'SOCIETE_TP', 'SOCIETE_CNSS',
            // Associe (first)
            ...
            'ASSOCIE_POURCENTAGE', 'ASSOCIE_NUMEROTATION',
            // Gerant (dedicated)
            'GERANT_NOM_COMPLET', 'GERANT_CIVILITE', 'GERANT_NOM', 'GERANT_PRENOM',
            'GERANT_CIN', 'GERANT_DATE_NAISSANCE', 'GERANT_LIEU_NAISSANCE',
            'GERANT_NATIONALITE', 'GERANT_ADRESSE', 'GERANT_QUALITE', 'GERANT_DUREE_GERANCE',
            // Contrat
            ...
            'ACTIVITES_OMPIC', 'OMPIC_INLINE', 'OMPIC_PUCES', 'NB_OMPIC', 'SOCIETE_ACTIVITE_OMPIC',
            // Cession
            'CESSION_DATE', 'CESSION_DOSSIER', 'CESSION_STATUS', 'CESSION_MOTIF',
            'CEDANT_NOM_COMPLET', 'CEDANT_CIN', 'CEDANT_CIVILITE',
            'CEDANT_DATE_NAISSANCE', 'CEDANT_LIEU_NAISSANCE',
            'CEDANT_NATIONALITE', 'CEDANT_ADRESSE',
            ...
            'CESSIONNAIRE_TELEPHONE', 'CESSIONNAIRE_EMAIL', 'CESSIONNAIRE_QUALITE',
            'CESSIONNAIRE_PARTS', 'CESSIONNAIRE_CAPITAL_DETENU', 'CESSIONNAIRE_EST_GERANT',
    ...
    public static function inferSection(string $variableName): string
    {
        ...
        $societeTokens = ['STE', 'SOCIETE', 'DEN', 'FORME', 'ICE', 'RC', 'IF', 'TP', 'CNSS', 'TRIBUNAL', 'CAPITAL', 'PART', 'ACTIVITY', 'ACTIVIT', 'VALEUR_NOMINALE', 'DOSSIER', 'PROCEDURE', 'MODE_DEPOT'];
