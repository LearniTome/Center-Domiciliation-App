...
class TemplateAnalyzer
{
    ...
    public static function getExpectedContextKeys(): array
    {
        return [
            ...
            'ASSOCIE_CIN', 'ASSOCIE_DATE_NAISSANCE', 'ASSOCIE_LIEU_NAISSANCE',
            ...
            // Alias rétrocompatibles (anciens noms utilisés dans les templates DOCX)
            'DENOMINATION_SOCIALE', 'RAISON_SOCIALE', 'DEN_STE',
            'FORME_JURIDIQUE', 'FORME_JUR', 'CONTRAT_FORME_JURIDIQUE',
            'CAPITAL_SOCIAL', 'NOMBRE_PARTS', 'NOMBRE_PARTS_SOCIALES',
            'NUMERO_ICE', 'ICE', 'VILLE', 'ADRESSE_SIEGE_SOCIAL',
            'TRIBUNAL_COMPETENT', 'DATE_IMMATRICULATION_ICE',
            'NUM_RC', 'NUM_DEPOT_RC',
            'NOM_ASSOCIE', 'NOM', 'PRENOM_ASSOCIE', 'PRENOM',
            'CIVILITE_ASSOCIE', 'CIVIL', 'NOM_COMPLET',
            'NUMERO_CIN_ASSOCIE', 'DATE_NAISSANCE_ASSOCIE', 'LIEU_NAISSANCE_ASSOCIE',
            'NATIONALITE_ASSOCIE', 'ADRESSE_ASSOCIE', 'EMAIL_ASSOCIE',
            'TELEPHONE_ASSOCIE', 'QUALITE_ASSOCIE', 'DATE_VALIDITE_CIN_ASSOCIE',
            'DATE_CONTRAT', 'DATE_DEBUT_CONTRAT', 'DATE_FIN_CONTRAT', 'DUREE_CONTRAT_MOIS',
            'PACK_DEMARRAGE_LOYER_MENSUEL', 'PACK_DEMARRAGE_TOTAL_TTC',
            'RENOUVELLEMENT_LOYER_ANNUEL', 'RENOUVELLEMENT_LOYER_MENSUEL',
            'DTAE_CONTRAT',
        ];
    }
