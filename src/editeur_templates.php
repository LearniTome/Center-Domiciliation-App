...
class TemplateEditor
{
    ...
    public static function getAvailableVariables(): array
    {
        return [
            ...
            'Activites' => [
                'ACTIVITES' => 'Liste des activites (pour boucle)',
                'ACTIVITES_INLINE' => 'Activites en ligne (;)',
            ...
            'Cession' => [
                'CESSION_DATE' => 'Date de cession',
                'CESSION_DOSSIER' => 'Dossier cession',
                'CESSION_STATUS' => 'Statut',
                'CESSION_MOTIF' => 'Motif de cession',
                'PARTS_CEDEES' => 'Nombre de parts cedees',
                'PRIX_UNITAIRE' => 'Prix unitaire',
                'PRIX_TOTAL' => 'Prix total',
                'CAPITAL_APRES' => 'Capital apres cession',
                'PARTS_APRES' => 'Parts apres cession',
                'NB_CEDANTS' => 'Nombre de cedants',
                'NB_CESSIONNAIRES' => "Nombre de cessionnaires",
            ],
            'Cedant' => [
                'CEDANT_NOM_COMPLET' => 'Nom complet',
                'CEDANT_CIN' => 'CIN',
                'CEDANT_CIVILITE' => 'Civilite',
                'CEDANT_DATE_NAISSANCE' => 'Date naissance',
                'CEDANT_LIEU_NAISSANCE' => 'Lieu naissance',
                'CEDANT_NATIONALITE' => 'Nationalite',
                'CEDANT_ADRESSE' => 'Adresse',
            ],
            'Cessionnaire' => [
                'CESSIONNAIRE_NOM_COMPLET' => 'Nom complet',
                'CESSIONNAIRE_CIN' => 'CIN',
                'CESSIONNAIRE_CIVILITE' => 'Civilite',
                'CESSIONNAIRE_DATE_NAISSANCE' => 'Date naissance',
                'CESSIONNAIRE_LIEU_NAISSANCE' => 'Lieu naissance',
                'CESSIONNAIRE_NATIONALITE' => 'Nationalite',
                'CESSIONNAIRE_ADRESSE' => 'Adresse',
                'CESSIONNAIRE_TELEPHONE' => 'Telephone',
                'CESSIONNAIRE_EMAIL' => 'Email',
                'CESSIONNAIRE_QUALITE' => 'Qualite',
                'CESSIONNAIRE_PARTS' => 'Parts',
                'CESSIONNAIRE_CAPITAL_DETENU' => 'Capital detenu',
                'CESSIONNAIRE_EST_GERANT' => 'Est gerant',
            ],
            'Dates' => [
