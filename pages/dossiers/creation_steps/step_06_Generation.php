...
if (is_post() && $step === 6) {
    ...
    if ($navAction === 'create_dossier') {
        ...
        try {
            ...
            ');
            $societeStmt->execute([
                'societe_dossier_domiciliation_number' => $wizard['societe']['societe_dossier_domiciliation_number'] ?? null,
                'societe_dossier_creation_number' => ($wizard['societe']['societe_type_generation'] ?? '') === 'creation' ? ($wizard['societe']['societe_dossier_creation_number'] ?? null) : null,
