        ...
        <div class="table-scroll">
            <table data-sortable>
                ...
                <?php foreach ($associes as $associe): ?>
                    <tr data-href="<?= e(app_url('associe', ['id' => (int) $associe['id']])) ?>">
                            ...
                            <td><span class="help-text"><?php $modifTime = file_exists($doc['fichier_docx']) ? filemtime($doc['fichier_docx']) : null; echo $modifTime ? date('d/m/Y H:i', $modifTime) : '-'; ?></span></td>
                                <td>
                                    <div class="table-actions">
                                        ...
                                        <a class="btn-icon success" href="<?= e(str_replace(dirname(__DIR__, 2) . '/', '', $doc['fichier_docx'])) ?>" download title="Telecharger DOCX">
                                            <span class="material-symbols-outlined">download</span>
                                        </a>
                                        <?php if ($doc['fichier_pdf']): ?>
                                            <a class="btn-icon danger" href="<?= e(str_replace(dirname(__DIR__, 2) . '/', '', $doc['fichier_pdf'])) ?>" download title="Telecharger PDF">
        ...
        <table data-sortable>
            ...
            <tbody>
                <?php foreach ($uploadedDocsList as $ud):
                    $relativePath = str_replace('\\', '/', str_replace(dirname(__DIR__, 2) . '/', '', $ud['filepath']));
