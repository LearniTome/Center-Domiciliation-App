        ...
        <div class="modal-panel">
            ...
            <form data-quick-create-form>
                ...
                <div class="form-grid" style="grid-template-columns:repeat(3,1fr)">
                    ...
                    <label class="field"><span>Ville</span><select name="societe_ville" data-ville-filter><option value="">Selectionner</option><?php foreach ($villesOptions as $opt): ?><option value="<?= e($opt) ?>"><?= e($opt) ?></option><?php endforeach; ?></select></label>
