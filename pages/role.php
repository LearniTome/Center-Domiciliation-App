...
// Build permission matrix: actions (rows) × categories (cols)
$actionLabels = [
    'view' => 'Voir',
    'create' => 'Créer',
    'edit' => 'Modifier',
...
$permMatrix = []; // [actionKey][catKey] = permission row
$activeActions = [];
...
// Order actions by $actionOrder, append any unknown ones at end
