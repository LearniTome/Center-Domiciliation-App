...
<section class="stats small stats-bottom-margin">
    ...
    <article class="stat">
        <span>Statut</span>
        <strong><?= ($cession['cession_status'] ?? 'brouillon') === 'Valider' ? 'Valider' : 'Brouillon' ?></strong>
    </article>
    <article class="stat">
        <span>Date</span>
...
<article class="card">
    <div class="section-header">
        <h3 style="color:var(--primary)">Lignes de cession <span>(<?= count($cessionParts) ?>)</span></h3>
    </div>
    <?php if (!$cessionParts): ?>
...
<article class="card">
    <div class="section-header">
        <h3 style="color:var(--primary)">Documents generes <span>(<?= count($documents) ?>)</span></h3>
    </div>
    <?php if (!$documents): ?>
